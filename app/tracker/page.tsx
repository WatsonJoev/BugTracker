  ...
  return (
    <main className="mx-auto justify-center flex">
      <div className='w-full md:container'>
        <Link className="flex justify-center w-fit mx-auto" href="/tracker/issues/new">
          <Button variant={'default'} className="btn btn-wide my-3">
            Raise an Issue
          </Button>
        </Link>
        <div className='flex justify-center'>
          <div className="stats shadow my-10 py-5 flex flex-col md:flex-row md:w-fit justify-center">
